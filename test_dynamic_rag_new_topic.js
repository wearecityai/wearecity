...
async function testDynamicRAGNewTopic() {
    try {
        console.log('🧪 Testing Dynamic RAG with NEW topic...');
        ...
        // Consulta sobre un tema que NO está en el RAG estático
        console.log('\n📝 === CONSULTA NUEVA (Router + Almacenamiento) ===');
        const query1 = '¿Cuáles son los horarios de atención del ayuntamiento de La Vila Joiosa?';
        ...
        console.log('\n🎯 === RESUMEN DEL TEST ===');
        console.log('1. Primera consulta: Router + Almacenamiento (tema nuevo)');
