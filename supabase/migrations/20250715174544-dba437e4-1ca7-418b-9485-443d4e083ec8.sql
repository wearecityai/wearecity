-- Fix the enum values to match the application code
...
UPDATE public.profiles SET role = 'ciudadano'::user_role WHERE role = 'citizen'::user_role;
UPDATE public.profiles SET role = 'administrativo'::user_role WHERE role = 'admin'::user_role;
