...
async function testPadronQuery() {
    try {
        console.log('🧪 Testing RAG with padron query...');
        
        const functionUrl = 'https://processaichat-7gaozpdiza-uc.a.run.app';
        
        const testQuery = 'como darme de alta en el padron?';
        ...
        console.error('❌ Error testing padron query:', error);
    }
}
