...
exports.buildSystemPrompt = exports.buildDynamicInstructions = exports.ANTI_LEAK_CLAUSE = exports.SHOW_MAP_MARKER_END = exports.SHOW_MAP_MARKER_START = exports.EVENT_CARD_END_MARKER = exports.EVENT_CARD_START_MARKER = exports.PLACE_CARD_END_MARKER = exports.PLACE_CARD_START_MARKER = void 0;
...
- Usuario: "¿Dónde está el museo?" → NO mencionar la hora actual`);
    ...
    if (userMessage.toLowerCase().includes('evento'))
        intents.add('events');
    if (userMessage.toLowerCase().includes('lugar') || userMessage.toLowerCase().includes('restaurante') || userMessage.toLowerCase().includes('hotel'))
        intents.add('places');
    if (userMessage.toLowerCase().includes('trámite') || userMessage.toLowerCase().includes('documento'))
...
---`);
    ...
    parts.push((0, formattingInstructions_1.getFormattingInstructions)());
    parts.push(exports.ANTI_LEAK_CLAUSE);
    return parts.join('\n\n');
}
exports.buildSystemPrompt = buildSystemPrompt;
//# sourceMappingURL=vertexAIInstructionsNew.js.map