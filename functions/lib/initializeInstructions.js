...
exports.checkInstructionsStatus = exports.initializeInstructionsInFirebase = void 0;
 ...
 */
async function initializeInstructionsInFirebase() {
    try {
        const db = admin.firestore();
        console.log('🚀 Inicializando instrucciones en Firebase...');
        // 1. Crear configuración por defecto para ciudades
        await db.collection('ai_instructions').doc('default_city_config').set(Object.assign(Object.assign({}, DEFAULT_CITY_CONFIG), { lastUpdated: admin.firestore.FieldValue.serverTimestamp(), createdBy: 'system' }));
        ...
        const valenciaConfig = Object.assign(Object.assign({}, DEFAULT_CITY_CONFIG), { cityName: "Valencia", assistantName: "Asistente IA Oficial de Valencia", cityType: "capital de provincia", region: "Comunidad Valenciana", specializedServices: "turismo de playa, patrimonio histórico, gastronomía mediterránea", officialWebsite: "www.valencia.es", sedeElectronicaUrl: "sede.valencia.es", municipalPhone: "010", officeHours: "Lunes a Viernes 9:00-14:00, Martes y Jueves 17:00-19:00", eventCalendarUrls: "www.valencia.es/agenda, www.turisvalencia.es", cultureWebsites: "www.turisvalencia.es, www.culturaydeporte.gob.es", typicalPlaces: "Ciudad de las Artes y las Ciencias, Barrio del Carmen, Plaza de la Virgen, Mercado Central", localFood: "Paella valenciana, horchata, turrones, fideuá, all i pebre", mainMonuments: "Catedral de Valencia, Torres de Serranos, Lonja de la Seda, Palacio del Marqués de Dos Aguas", transportInfo: "Metro de Valencia, EMT autobuses, TRAM, Cercanías Renfe, bicicletas públicas", emergencyContacts: "092 Policía Local, 061 Emergencias Sanitarias, 112 Emergencias Generales", hospitals: "Hospital General de Valencia, Hospital La Fe, Hospital Clínico", pharmacyInfo: "Servicio de farmacias de guardia 24/7, consultar en farmacias locales", cityHistory: "Valencia fue fundada por los romanos en el año 138 a.C. y ha sido un importante centro cultural y comercial a lo largo de la historia. Capital del Reino de Valencia durante la Edad Media, es conocida por su rico patrimonio histórico y cultural.", interestingFacts: "Valencia tiene la mayor extensión de huerta urbana de Europa, la Ciudad de las Artes y las Ciencias es el complejo científico-cultural más grande de España, y la paella valenciana es Patrimonio Cultural Inmaterial de la Humanidad.", localTraditions: "Las Fallas (declaradas Patrimonio Cultural Inmaterial), la Tomatina de Buñol, el Tribunal de las Aguas, las fiestas de San Vicente Ferrer", localFestivals: "Las Fallas (marzo), Feria de Julio, Feria de San Vicente, Semana Santa Marinera", cityHallInfo: "Plaza del Ayuntamiento, 1. Horario: L-V 9:00-14:00, M y J 17:00-19:00", mayorInfo: "María José Catalá Verdet (PP) desde 2023", usefulPhones: "010 Atención Ciudadana, 012 Información General, 900 100 100 Emergencias", customInstructions: "Valencia es una ciudad mediterránea con un clima suave todo el año. Prioriza información sobre playas, gastronomía local, eventos culturales y transporte público. La ciudad es muy accesible para turistas y tiene una excelente infraestructura turística.", lastUpdated: admin.firestore.FieldValue.serverTimestamp(), createdBy: 'system' });
...
exports.initializeInstructionsInFirebase = initializeInstructionsInFirebase;
/**
 * Función para verificar el estado de las instrucciones
 */
async function checkInstructionsStatus() {
    try {
        const db = admin.firestore();
...
exports.checkInstructionsStatus = checkInstructionsStatus;
...
//# sourceMappingURL=initializeInstructions.js.map