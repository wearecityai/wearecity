 ...
 */
export const clearAllRAGData = async () => {
 ...
 */
export const clearCityRAGData = async (citySlug: string) => {
 ...
 */
export const clearRAGData = functions.https.onRequest(async (req, res) => {
  return corsHandler(req, res, async () => {
    try {
      console.log('🚀 Starting RAG data cleanup...');
      
      const result = await clearAllRAGData();
 ...
 */
export const clearCityRAGDataFunction = functions.https.onRequest(
  corsHandler(async (req, res) => {
    try {
      ...
      const result = await clearCityRAGData(citySlug);
