...
export class ValidationService {
   ...
   */
  static validateChatQuery(query: any): string {
    if (!query) {
   ...
   */
  static validateSearchRequest(request: any): {
    query: string;
    num?: number;
    start?: number;
    language?: string;
   ...
   * Validate city slug
   */
  static validateCitySlug(citySlug: any): string | undefined {
   ...
   */
  static validateConversationHistory(history: any): any[] {
    if (!history) {
      return [];
    }
    ...
    return history.map((message: any, index: number) => {
   ...
   * Validate media URL
   */
  static validateMediaUrl(mediaUrl: any): string | undefined {
    if (!mediaUrl) {
      return undefined;
    }
   ...
   * Validate media type
   */
  static validateMediaType(mediaType: any): string | undefined {
    if (!mediaType) {
      return undefined;
    }
